...
function buildDraftFromRequest(payload: ReusePayload): ParsedIcpDraft | null {
  ...
  return {
    ...
    company_country: asList(icp.company_country ?? icp.country),
    company_region: icp.company_region ?? icp.geography ?? '',
    contact_country: asList(icp.contact_country),
    contact_region: icp.contact_region ?? '',
    country: asList(icp.company_country ?? icp.country),
    geography: icp.company_region ?? icp.geography ?? '',
